...
const Home = () => (
  <section id="home" className="home-section text-center">
    ...
    <div className="container">
      ...
      <p className="home-section-paragraph">Exchange Skills and Knowledge within Your Community</p>
      <a href="/portal.html" className="btn btn-primary" target="_blank">Get Started</a>
    </div>
  </section>
);
